...
# main program
def main():
    st.title('BEAUTY FACE ANALYSIS AND RECCOMEDATION SYSTEM')
    ...
    if st.button('CAPTURE IMAGE'):
        ...
        kartik_image = "filename.jpg"
        st.image(kartik_image , width=250, height=250,channels='RGB')
    else:
        print('kartik op')
    ...
    if st.button('Submit'):
        ...
        data = {"image_name":image_name , "user_name":input_name , "user_email":input_email, "user_age":input_age , "user_gender":input_gender,'image_name':image_name}
